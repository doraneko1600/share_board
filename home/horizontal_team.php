        ...
        <?php foreach($tr as $td){ ?>
            <?php if($td != date('j')){ ?>
                <?php if(in_array($td,$key)){ ?>
                    <td class="plan"><a href="" class="widelink_team" id="id"  data-target="modal01"><?php echo $td ?></a></td>
                <?php }else{ ?>
                    <td><?php echo $td ?></td>
                <?php } ?>
                ...
                <?php }else{ ?>
                <?php if(in_array($td,$key)){ ?>
                    <td class="today_plan"><a href="" class="widelink_team" id="id"  data-target="modal01"><?php echo $td ?></a></td>
                <?php }else{ ?>
                <!-- 今日の日付 -->
...
<div id="modal01" class="modal js-modal">
    ...
    <div class="modal__content"><!--モーダルの中身-->
